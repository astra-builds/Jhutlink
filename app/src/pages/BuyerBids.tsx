...
export default function BuyerBids() {
      ...
      <div className="flex h-[100dvh] bg-void">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="ml-4 text-text-secondary">Loading active bids...</p>
          </div>
        </main>
      </div>
    );
      ...
      <div className="flex h-[100dvh] bg-void">
        ...
        <main className="flex-1 flex flex-col">
          <div className="bg-base-elevated border-b border-white/[0.04] px-6 py-4">
            <h1 className="text-xl font-semibold text-text-primary">Active Bids</h1>
          </div>
          <div className="flex-1 p-6">
            <div className="text-center py-12">
              <p className="text-text-tertiary">You don't have any active bids yet.</p>
              <p className="text-sm text-text-tertiary mb-4">
                When you place bids on listings, they will appear here with their current status.
              </p>
  ...
  return (
    <div className="flex h-[100dvh] bg-void">
      ...
      <main className="flex-1 flex flex-col">
        <div className="bg-base-elevated border-b border-white/[0.04] px-6 py-4">
          <h1 className="text-xl font-semibold text-text-primary">Active Bids ({bids.length})</h1>
        </div>
                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-text-tertiary text-sm">
                      {formatKg(bid.quantity_kg)} @ {formatCurrency(bid.price_per_kg_taka)}/kg
                    </p>
                  </div>
